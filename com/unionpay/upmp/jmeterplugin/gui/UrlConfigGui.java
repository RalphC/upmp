...
public class UrlConfigGui extends JPanel implements ChangeListener {
    ...
    public void clear() {
        ...
        if (notConfigOnly){
            ...
            useBrowserCompatibleMultipartMode.setSelected(UPMPSamplerBase.BROWSER_COMPATIBLE_MULTIPART_MODE_DEFAULT);
        }
    ...
    public void modifyTestElement(TestElement element) {
        ...
        if (notConfigOnly){
            ...
            element.setProperty(new BooleanProperty(UPMPSamplerBase.FOLLOW_REDIRECTS, followRedirects.isSelected()));
            ...
            element.setProperty(new BooleanProperty(UPMPSamplerBase.DO_MULTIPART_POST, useMultipartForPost.isSelected()));
            element.setProperty(UPMPSamplerBase.BROWSER_COMPATIBLE_MULTIPART, useBrowserCompatibleMultipartMode.isSelected(),UPMPSamplerBase.BROWSER_COMPATIBLE_MULTIPART_MODE_DEFAULT);
        }
        if (showImplementation) {
    ...
    public void configure(TestElement el) {
        ...
        boolean useRaw = el.getPropertyAsBoolean(UPMPSamplerBase.POST_BODY_RAW, UPMPSamplerBase.POST_BODY_RAW_DEFAULT);
        if(useRaw) {
        ...
        if (notConfigOnly){
            ...
            useBrowserCompatibleMultipartMode.setSelected(el.getPropertyAsBoolean(
            		UPMPSamplerBase.BROWSER_COMPATIBLE_MULTIPART, UPMPSamplerBase.BROWSER_COMPATIBLE_MULTIPART_MODE_DEFAULT));
        }
        if (showImplementation) {
    ...
    private void init() {// called from ctor, so must not be overridable
        ...
        webRequestPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), UPMPConstant.upmp_request)); // $NON-NLS-1$
    ...
    protected final JPanel getWebServerTimeoutPanel() {
        ...
        webServerPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
                UPMPConstant.upmp_server)); // $NON-NLS-1$
