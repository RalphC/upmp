...
public abstract class UPMPSamplerBase extends AbstractSampler implements
    ...
    private static final Set<String> APPLIABLE_CONFIG_CLASSES = new HashSet<String>(
            Arrays.asList(new String[]{
                    ...
                    "com.unionpay.upmp.jmeterplugin.gui.UPMPDefaultsGui",
                    "org.apache.jmeter.config.gui.SimpleConfigGui",
                    "com.unionpay.upmp.jmeterplugin.gui.HeaderPanel",
                    "com.unionpay.upmp.jmeterplugin.gui.AuthPanel",
                    "com.unionpay.upmp.jmeterplugin.gui.CacheManagerGui",
                    "com.unionpay.upmp.jmeterplugin.gui.CookiePanel"}));
    
    //+ JMX names - do not change
    public static final String ARGUMENTS = "UPMPSampler.Arguments"; // $NON-NLS-1$

    public static final String AUTH_MANAGER = "UPMPSampler.auth_manager"; // $NON-NLS-1$

    public static final String COOKIE_MANAGER = "UPMPSampler.cookie_manager"; // $NON-NLS-1$

    public static final String CACHE_MANAGER = "UPMPSampler.cache_manager"; // $NON-NLS-1$

    public static final String HEADER_MANAGER = "UPMPSampler.header_manager"; // $NON-NLS-1$

    public static final String DOMAIN = "UPMPSampler.domain"; // $NON-NLS-1$

    public static final String PORT = "UPMPSampler.port"; // $NON-NLS-1$

    public static final String PROXYHOST = "UPMPSampler.proxyHost"; // $NON-NLS-1$

    public static final String PROXYPORT = "UPMPSampler.proxyPort"; // $NON-NLS-1$

    public static final String PROXYUSER = "UPMPSampler.proxyUser"; // $NON-NLS-1$

    public static final String PROXYPASS = "UPMPSampler.proxyPass"; // $NON-NLS-1$

    public static final String CONNECT_TIMEOUT = "UPMPSampler.connect_timeout"; // $NON-NLS-1$

    public static final String RESPONSE_TIMEOUT = "UPMPSampler.response_timeout"; // $NON-NLS-1$

    public static final String METHOD = "UPMPSampler.method"; // $NON-NLS-1$

    /** This is the encoding used for the content, i.e. the charset name, not the header "Content-Encoding" */
    public static final String CONTENT_ENCODING = "UPMPSampler.contentEncoding"; // $NON-NLS-1$

    public static final String IMPLEMENTATION = "UPMPSampler.implementation"; // $NON-NLS-1$

    public static final String PATH = "UPMPSampler.path"; // $NON-NLS-1$

    public static final String FOLLOW_REDIRECTS = "UPMPSampler.follow_redirects"; // $NON-NLS-1$

    public static final String AUTO_REDIRECTS = "UPMPSampler.auto_redirects"; // $NON-NLS-1$

    public static final String PROTOCOL = "UPMPSampler.protocol"; // $NON-NLS-1$
     ...
     */
    public static final String IP_SOURCE = "UPMPSampler.ipSource"; // $NON-NLS-1$

    public static final String USE_KEEPALIVE = "UPMPSampler.use_keepalive"; // $NON-NLS-1$

    public static final String DO_MULTIPART_POST = "UPMPSampler.DO_MULTIPART_POST"; // $NON-NLS-1$

    public static final String BROWSER_COMPATIBLE_MULTIPART  = "UPMPSampler.BROWSER_COMPATIBLE_MULTIPART"; // $NON-NLS-1$
    
    public static final String CONCURRENT_DWN = "UPMPSampler.concurrentDwn"; // $NON-NLS-1$
    
    public static final String CONCURRENT_POOL = "UPMPSampler.concurrentPool"; // $NON-NLS-1$
    ...
    private static final long AWAIT_TERMINATION_TIMEOUT = 
        JMeterUtils.getPropDefault("upmpsampler.await_termination_timeout", 60); // $NON-NLS-1$ // default value: 60 secs 
    
    private static final boolean IGNORE_FAILED_EMBEDDED_RESOURCES = 
            JMeterUtils.getPropDefault("upmpsampler.ignore_failed_embedded_resources", false); // $NON-NLS-1$ // default value: false
    ...
    private static final String FILE_ARGS = "UPMPSampler.Files"; // $NON-NLS-1$
    // MIMETYPE is kept for backward compatibility with old test plans
    private static final String MIMETYPE = "UPMPSampler.mimetype"; // $NON-NLS-1$
    // FILE_NAME is kept for backward compatibility with old test plans
    private static final String FILE_NAME = "UPMPSampler.FILE_NAME"; // $NON-NLS-1$
    /* Shown as Parameter Name on the GUI */
    // FILE_FIELD is kept for backward compatibility with old test plans
    private static final String FILE_FIELD = "UPMPSampler.FILE_FIELD"; // $NON-NLS-1$

    public static final String CONTENT_TYPE = "UPMPSampler.CONTENT_TYPE"; // $NON-NLS-1$

    // IMAGE_PARSER now really means EMBEDDED_PARSER
    public static final String IMAGE_PARSER = "UPMPSampler.image_parser"; // $NON-NLS-1$

    // Embedded URLs must match this RE (if provided)
    public static final String EMBEDDED_URL_RE = "UPMPSampler.embedded_url_re"; // $NON-NLS-1$

    public static final String MONITOR = "UPMPSampler.monitor"; // $NON-NLS-1$

    // Store MD5 hash instead of storing response
    private static final String MD5 = "UPMPSampler.md5"; // $NON-NLS-1$
    ...
    protected static final String NON_HTTP_RESPONSE_CODE = "Non UPMP response code";

    protected static final String NON_HTTP_RESPONSE_MESSAGE = "Non UPMP response message";

    public static final String POST_BODY_RAW = "UPMPSampler.postBodyRaw"; // TODO - belongs elsewhere 
    ...
    protected static final int MAX_REDIRECTS = JMeterUtils.getPropDefault("upmpsampler.max_redirects", 5); // $NON-NLS-1$

    protected static final int MAX_FRAME_DEPTH = JMeterUtils.getPropDefault("upmpsampler.max_frame_depth", 5); // $NON-NLS-1$
    ...
    private static final String RESPONSE_PARSERS= // list of parsers
        JMeterUtils.getProperty("UPMPResponse.parsers");//$NON-NLS-1$
    ...
    private static final boolean REMOVESLASHDOTDOT = JMeterUtils.getPropDefault("upmpsampler.redirect.removeslashdotdot", true);

    ////////////////////// Code ///////////////////////////

    public UPMPSamplerBase() {
   ...
   public void setMD5(boolean truth) {
     ...
     */
    protected UPMPSampleResult errorResult(Throwable e, UPMPSampleResult res) {
     ...
     * @return results of the sampling
     */
    protected abstract UPMPSampleResult sample(URL u,
     ...
     */
    protected UPMPSampleResult downloadPageResources(UPMPSampleResult res, UPMPSampleResult container, int frameDepth) {
        ...
        try {
            ...
            res.addSubResult(errorResult(e, new UPMPSampleResult(res)));
        ...
        if (urls != null && urls.hasNext()) {
            if (container == null) {
                ...
                container = new UPMPSampleResult(res);
            ...
            while (urls.hasNext()) {
                ...
                try {
                    ...
                    if (url == null) {
                        ...
                        if (!urlstr.equals(urlStrEnc)){// There were some spaces in the URL
                            try {
                                ...
                                res.addSubResult(errorResult(new Exception(urlStrEnc + " is not a correct URI"), new UPMPSampleResult(res)));
                                setParentSampleSuccess(res, false);
                                continue;
                            }
                        }
                    ...
                    res.addSubResult(errorResult(new Exception(binURL + " is not a correct URI"), new UPMPSampleResult(res)));
                    setParentSampleSuccess(res, false);
                    continue;
                }
            }
     ...
     */
    private void setParentSampleSuccess(UPMPSampleResult res, boolean initialValue) {
     ...
     */
    private String getParserClass(UPMPSampleResult res) {
    ...
    @Override
    public Object clone() {
        UPMPSamplerBase base = (UPMPSamplerBase) super.clone();
        return base;
    }
     ...
     */
    protected UPMPSampleResult followRedirects(UPMPSampleResult res, int frameDepth) {
    	UPMPSampleResult totalRes = new UPMPSampleResult(res);
        totalRes.addRawSubResult(res);
        UPMPSampleResult lastRes = res;
        ...
        if (redirect >= MAX_REDIRECTS) {
            lastRes = errorResult(new IOException("Exceeeded maximum number of redirects: " + MAX_REDIRECTS), new UPMPSampleResult(lastRes));
            totalRes.addSubResult(lastRes);
        }
     ...
     */
    protected UPMPSampleResult resultProcessing(boolean areFollowingRedirect, int frameDepth, UPMPSampleResult res) {
    ...
    private static class ASyncSample implements Callable<AsynSamplerResultHolder> {
        ...
        private final UPMPSamplerBase sampler;
		private final JMeterContext jmeterContextOfParentThread;

        ASyncSample(URL url, String method,
                boolean areFollowingRedirect, int depth,  CookieManager cookieManager, UPMPSamplerBase base){
            this.url = url;
            this.method = method;
            this.areFollowingRedirect = areFollowingRedirect;
            this.depth = depth;
            this.sampler = (UPMPSamplerBase) base.clone();
        ...
        public AsynSamplerResultHolder call() {
            ...
            UPMPSampleResult UPMPSampleResult = sampler.sample(url, method, areFollowingRedirect, depth);
            if(sampler.getCookieManager() != null) {
                CollectionProperty cookies = sampler.getCookieManager().getCookies();
                return new AsynSamplerResultHolder(UPMPSampleResult, cookies);
            } else {
                return new AsynSamplerResultHolder(UPMPSampleResult, new CollectionProperty());
            }
        }
    }
    ...
    private static class CleanerThread extends Thread {
        private final List<UPMPSamplerBase> samplersToNotify = new ArrayList<UPMPSamplerBase>();
        /**
        ...
        public void notifyThreadEnd() {
            for (UPMPSamplerBase samplerBase : samplersToNotify) {
         ...
         * @param sampler {@link UPMPSamplerBase}
         */
        public void registerSamplerForEndNotification(UPMPSamplerBase sampler) {
    ...
    private static class AsynSamplerResultHolder {
        private final UPMPSampleResult result;
        private final CollectionProperty cookies;
        /**
         * @param result
         * @param cookies
         */
        public AsynSamplerResultHolder(UPMPSampleResult result, CollectionProperty cookies) {
            super();
            this.result = result;
         ...
         * @return the result
         */
        public UPMPSampleResult getResult() {
            return result;
        }
        /**
         * @return the cookies
